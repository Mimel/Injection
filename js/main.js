...
(function() {
  (function($) {
    var InjectionRunner, Node, canvas, commandDictionary, compTypes, consoleImg, ctxt, fieldStarter, network, nodeChildrenDistance, nodeStarter, nullChar, redraw, renderView, serverImg, storeChar, valueStarter;
    nodeStarter = '@';
    fieldStarter = '#';
    storeChar = '$';
    nullChar = '~';
