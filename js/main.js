...
(function() {
  (function($) {
    var InjectionRunner, Node, canvas, commandDictionary, ctxt, currentRunner, fieldStarter, goal, iconSpriteSheet, mission, network, nodeChildrenDistance, nodeStarter, nullChar, redraw, renderView, starter, storeChar, valueStarter;
    nodeStarter = '@';
    fieldStarter = '#';
    storeChar = '$';
    nullChar = '~';
...
// Go to compare all fields of children.
    ...
    iconSpriteSheet.onload = function() {
      return $.getJSON('https://api.myjson.com/bins/gz2he').done(function(data) {
