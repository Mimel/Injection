...
(function() {
  (function($) {
    var InjectionRunner, Node, canvas, commandDictionary, ctxt, currentRunner, fieldStarter, goal, iconSpriteSheet, loadJSON, mission, network, nodeChildrenDistance, nodeStarter, nullChar, redraw, renderView, starter, storeChar, valueStarter;
    nodeStarter = '@';
    fieldStarter = '#';
    storeChar = '$';
    nullChar = '~';
